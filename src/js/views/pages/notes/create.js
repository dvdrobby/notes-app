...
const Create = {
          ...
          <div class="col-12 col-sm-10 col-md-8 col-xl-6">
            <form id="createNoteForm">
              ...
              <div class="mb-3">
                ...
                <div class="mt-2">
                  <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#cameraModal">Get Text from Camera</button>
                </div>
              </div>
  ...
  _initialListener() {
    ...
    getTextFromPictureBtn.addEventListener('click', async (event) => {
      if (this._picture) {
        const myArr = this._picture.split('base64,')
        // console.log(myArr[1]);
        const {text} = await recognizePictureWithVision(myArr);
